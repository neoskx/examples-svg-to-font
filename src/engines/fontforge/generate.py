# fontforge python document: http://fontforge.github.io/en-US/documentation/scripting/python/
# fontforge python document: http://dmtr.org/ff.php#Font
...
logging.debug(args['fontHeight'])
logging.debug(args['descent'])
